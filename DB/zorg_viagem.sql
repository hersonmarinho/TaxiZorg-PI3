...
CREATE TABLE `viagem` (
  ...
  `tipo_viagem` varchar(45) DEFAULT NULL,
  `matricula_funcionario` int(11) DEFAULT NULL,
  PRIMARY KEY (`idviagem`),
  KEY `idfuncionario_idx` (`matricula_funcionario`),
  KEY `id_end_partida_idx` (`id_end_partida`),
...
-- Dump completed on 2016-05-19 21:46:57
